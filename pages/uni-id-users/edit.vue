  ...
  "email_confirmed_localdata": [
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field('username,password_secret_version,nickname,gender,status,mobile,mobile_confirmed,email,email_confirmed,avatar,avatar_file,department_id,wx_unionid,wx_openid,ali_openid,apple_openid,dcloud_appid,comment,realname_auth,score,last_login_date,last_login_ip,token,inviter_uid,invite_time,my_invite_code').get().then((res) => {
